...
<body>
    <div class="border-dark shadow-lg align-items-center highlight-clean" style="background-color: rgb(182,203,204);margin: 0;width: 100%;padding: 20px;padding-top: 60px;padding-bottom: 60px; border: 1px solid black;">
        <h2 class="text-center"><strong>Grade Calculator</strong></h2>
        <div class="container">
            <header></header>
        </div>
        <h5 class="text-center" style="font-weight: 400;">In HCPSS, overall course grades are the only grades that show up on your high school transcript. They are calculated based on quarterly grades and exam grades.<br><br>Use this calculator to predict your overall course grade for a semester-long high school course.<br><br>*If your class is quarter-long, your overall grade is your quarter grade.*<br><br><strong>UPDATE (October 22, 2020): These calculations have been revised to reflect adopted changes in HCPSS grade calculation as a result of the cancellation of final exams.</strong></h5>
            ...
            <table class="table table-striped">
               ...
               <?php
                  if(isset($_POST['submit'])) {
                        ...
                        echo preg_replace('/\s+/', ' ', "<br>$totalletter<br>");
